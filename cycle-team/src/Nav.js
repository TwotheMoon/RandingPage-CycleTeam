...
const Menu = styled.div`
    ...
    div{
        &:hover{
            opacity: ${props => props.menuIndex !== props.num && "0.1"};
            transition: 0.2s;
        }
        &:not(:hover){
            opacity: ${props => props.menuIndex !== props.num && "0"};
            transition: 0.2s;
        }
    }
    @media screen and (max-width: 500px){
...
`;
const IconWrapSecond = styled.div`
    position: absolute;
    top: -25px;
    width: auto;
    display: flex;
    ...
    return (
        <>
            <Section>
                <NavBar>
                    <MenuWrap>
                        <Menu onClick={() => setMenuIndex(1)} menuIndex={menuIndex} num={1}>
                            <MenuOverlay />
                            Team Moon
                        </Menu>
                        <Menu onClick={() => setMenuIndex(2)} menuIndex={menuIndex} num={2}>
                            <MenuOverlay />
                            About us
                        </Menu>
