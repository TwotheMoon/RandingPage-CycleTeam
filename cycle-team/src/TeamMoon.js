...
function TeamMoon() {
    ...
    return (
        <Section>
            ...
            <ContentWrap>
                <SmallContent date="22.1.23" url={cycle01} title="도심 퍼포먼스 테스트" desc="도시 내부와 도시 외곽의 구불구불한 그래블 코스까지 다양한 환경에서 실제 선수가 휠, 바디를 통해 느끼는 진동의 피곤함은 상상을 초월합니다. 경량과 내구성 두 마리의 토끼를 잡기 위해 테스트를 진행합니다." />
                <SmallContent date="22.1.7" url={cycle02} title="1번은 언제나 선수" desc="모든 사람들에게 맞는 머신은 없습니다. 하지만 단 한명을 위한 머신은 존재합니다. 항상 선수와의 소통, 회의를 통해 최고의 퍼포먼스를 내기 위한 노력을 합니다." />
